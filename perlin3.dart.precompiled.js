...
$isvs:true,
$isb8:true,
static:{"^":"ew,Ry,cp,Cd,NK",Dt:function(){return new P.vs(0,$.X3,null,null,null,null,null,null)},GZ:function(a,b){var z
b.Gv=2
z=J.x(a)
...
$isiP:true,
static:{"^":"Oj,Vp,df,p2,ch,QC,Px,NX,kc,Xs,k3,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Gi:function(){var z=new P.iP(Date.now(),!1)
z.EK()
return z}}},
Hn:{
"^":"Tp:13;",
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,zj,b2,jS,IG,Do,Cv,kT,IJ,V6,Vk,S8,rG",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:13;",
...
if(a<256)a=(a|a<<8)>>>0
for(z=this.Ot,y=this.Wz,x=a&255,w=0;w<256;++w){if((w&1)>0){v=$.zp()[w]
...
xn:{
"^":"a;x,y,z",
m1:function(a,b,c){return this.x*a+this.y*b+this.z*c}},
qL:{
"^":"Ng;Ot,Wz,FA,Yl,Mw,tK"}}],["","file:///A:/Projects/GitHub/noise_algorithms/web/perlin3.dart",,E,{
"^":"",
Iq:[function(){C.ol.gm6(window).ml(new E.em())
$.D2().appendChild($.jY())},"call$0","eE",0,0,0],
pn:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4
z=P.Gi()
...
r=C.CD.yu(Math.floor(u))
q=C.CD.yu(Math.floor(t))
p=x-s
o=u-r
n=t-q
s&=255
...
if(typeof u!=="number")return H.s(u)
u=r+u
if(u>>>0!==u||u>=512)return H.e(v,u)
u=v[u]
if(typeof u!=="number")return H.s(u)
u=s+u
if(u>>>0!==u||u>=512)return H.e(t,u)
m=t[u].m1(p,o,n)
u=q+1
l=v[u]
if(typeof l!=="number")return H.s(l)
l=r+l
if(l>>>0!==l||l>=512)return H.e(v,l)
l=v[l]
if(typeof l!=="number")return H.s(l)
l=s+l
if(l>>>0!==l||l>=512)return H.e(t,l)
k=n-1
j=t[l].m1(p,o,k)
l=r+1
i=v[q]
...
i=l+i
if(i>>>0!==i||i>=512)return H.e(v,i)
i=v[i]
if(typeof i!=="number")return H.s(i)
i=s+i
if(i>>>0!==i||i>=512)return H.e(t,i)
h=o-1
g=t[i].m1(p,h,n)
i=v[u]
if(typeof i!=="number")return H.s(i)
...
e=r+e
if(e>>>0!==e||e>=512)return H.e(v,e)
e=v[e]
if(typeof e!=="number")return H.s(e)
e=i+e
if(e>>>0!==e||e>=512)return H.e(t,e)
d=p-1
c=t[e].m1(d,o,n)
e=v[u]
if(typeof e!=="number")return H.s(e)
...
u=i+u
if(u>>>0!==u||u>=512)return H.e(t,u)
a0=p*p*p*(p*(p*6-15)+10)
a1=o*o*o*(o*(o*6-15)+10)
a2=n*n*n*(n*(n*6-15)+10)
i=1-a0
v=1-a2
a3=C.CD.yu(Math.abs((1-a1)*(v*(i*m+a0*c)+a2*(i*j+a0*b))+a1*(v*(i*g+a0*a)+a2*(i*f+a0*t[u].m1(d,h,k))))*256)
k=J.DO($.jY())
...
d=a4+2
u=k.length
if(d<0||d>=u)return H.e(k,d)
k[d]=a3
if(h<0||h>=u)return H.e(k,h)
k[h]=a3
if(a4<0||a4>=u)return H.e(k,a4)
k[a4]=a3
if(d>=u)return H.e(k,d)
k[d]=k[d]+P.y(0,(25-a3)*8)
d=$.TV()
k=a4+3
if(k>=d.length)return H.e(d,k)
d[k]=255}$.yt=$.yt+0.05
x=P.Gi()
v=$.H9()
...
C.ol.gm6(window).ml(new E.wc())},
em:{
"^":"Tp:7;",
call$1:function(a){return E.pn()}},
wc:{
"^":"Tp:7;",
call$1:function(a){return E.pn()}}},1],])
...
I.$lazy($,"data","nU","TV",function(){return J.Qd($.UQ())})
I.$lazy($,"rand","SQ","pB",function(){return C.pr})
I.$lazy($,"perlin","N0","yg",function(){var z,y
z=$.pB().j1(100)
y=Math.sqrt(3)
y=new V.qL(Array(512),Array(512),0.5*(y-1),(3-Math.sqrt(3))/6,0.3333333333333333,0.16666666666666666)
y.Ic(0)
y.Ic(z)
return y})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
xn.prototype=$desc
function qL(Ot,Wz,FA,Yl,Mw,tK){this.Ot=Ot
this.Wz=Wz
this.FA=FA
this.Yl=Yl
this.Mw=Mw
this.tK=tK}qL.builtin$cls="qL"
if(!"name" in qL)qL.name="qL"
$desc=$collectedClasses.qL
if($desc instanceof Array)$desc=$desc[1]
qL.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
wc.prototype=$desc
return[qE,Gh,fY,Mr,lJ,ct,nB,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,fW,d7,HA,vH,xO,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,Yu,iG,mK,xf,Vb,ST,tb,Sg,pA,Mi,In,wP,eP,A6,Og,M6,El,mC,SV,ZY,P1,Qb,xI,oU,eY,KV,KY,G7,l9,Ql,wL,SN,HD,rR,qj,nC,KR,fs,j2,lp,kd,I0,yN,Cp,HN,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,FH,RH,lz,vw,aG,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Zv,Dh,ZJ,mU,eZ,IT,JY,F3,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,lc,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,QN,N9,BA,d0,tp,rE,PI,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,ox,ZD,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,Jo,Qm,ET,LN,FK,Gv,kn,PE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,jP,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,Pf,mJ,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,iP,Hn,Zl,B5,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,Rn,wv,TH,IU,mg,b0,Pg,Ob,GV,nl,Ng,xn,qL,em,wc]}