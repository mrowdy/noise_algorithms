...
xp:{
"^":"Ng;Ot,Wz,FA,Yl,Mw,tK"}}],["","file:///A:/Projects/GitHub/noise_algorithms/web/simplex3.dart",,K,{
"^":"",
Iq:[function(){C.ol.gm6(window).ml(new K.em())
...
t=$.yt
s=(x+u+t)*v.Mw
r=C.CD.yu(Math.floor(x+s))
q=C.CD.yu(Math.floor(u+s))
p=C.CD.yu(Math.floor(t+s))
o=v.tK
n=(r+q+p)*o
m=x-r+n
l=u-q+n
...
b0=a9*a9*a5.m1(m,l,k)}b1=0.5-d*d-c*c-b*b
if(b1<0)b2=0
else{b1*=b1
b2=b1*b1*a6.m1(d,c,b)}b3=0.5-a*a-a0*a0-a1*a1
if(b3<0)b4=0
else{b3*=b3
b4=b3*b3*a7.m1(a,a0,a1)}v=0.5-a2*a2-a3*a3-a4*a4
if(v<0)b5=0
else{v*=v
b5=v*v*a8.m1(a2,a3,a4)}b6=C.CD.yu(Math.abs(32*(b0+b2+b4+b5))*256)
v=J.DO($.jY())
...
t=b7+2
o=v.length
if(t<0||t>=o)return H.e(v,t)
v[t]=b6
if(u<0||u>=o)return H.e(v,u)
v[u]=b6
if(b7<0||b7>=o)return H.e(v,b7)
v[b7]=b6
if(t>=o)return H.e(v,t)
v[t]=v[t]+P.y(0,(25-b6)*8)
t=$.TV()
v=b7+3
...
C.ol.gm6(window).ml(new K.wc())},
em:{
"^":"Tp:7;",
call$1:function(a){return K.pn()}},
wc:{
"^":"Tp:7;",
call$1:function(a){return K.pn()}}},1],])
...
z=$.pB().j1(100)
y=Math.sqrt(3)
y=new V.xp(Array(512),Array(512),0.5*(y-1),(3-Math.sqrt(3))/6,0.3333333333333333,0.16666666666666666)
y.Ic(0)
y.Ic(z)
return y})
...
if($desc instanceof Array)$desc=$desc[1]
xn.prototype=$desc
function xp(Ot,Wz,FA,Yl,Mw,tK){this.Ot=Ot
this.Wz=Wz
this.FA=FA
this.Yl=Yl
this.Mw=Mw
this.tK=tK}xp.builtin$cls="xp"
