...
xn:{
"^":"a;x,y,z",
Yv:function(a,b){return this.x*a+this.y*b}},
ed:{
"^":"Ng;Ot,Wz,FA,VC,Mw,tK"}}],["","file:///A:/Projects/GitHub/noise_algorithms/web/simplex2.dart",,R,{
"^":"",
Iq:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4
z=P.Gi()
for(y=0;y<$.q9;++y)for(x=y/100,w=0;w<$.fg;++w){v=$.Ih()
u=w/100
t=(x+u)*v.FA
s=C.CD.yu(Math.floor(x+t))
r=C.CD.yu(Math.floor(u+t))
q=v.VC
p=(s+r)*q
o=x-s+p
n=u-r+p
...
v=s+1+v
if(v>>>0!==v||v>=512)return H.e(u,v)
e=u[v]
d=0.5-o*o-n*n
if(d<0)c=0
else{d*=d
c=d*d*g.Yv(o,n)}b=0.5-k*k-j*j
if(b<0)a=0
else{b*=b
a=b*b*f.Yv(k,j)}a0=0.5-i*i-h*h
if(a0<0)a1=0
else{a0*=a0
a1=a0*a0*e.Yv(i,h)}a2=C.CD.yu(Math.abs(70*(c+a+a1))*256)
v=J.DO($.jY())
if(typeof v!=="number")return H.s(v)
a3=(y+w*v)*4
v=$.Gt()
...
q=a3+2
a4=v.length
if(q<0||q>=a4)return H.e(v,q)
v[q]=a2
if(u<0||u>=a4)return H.e(v,u)
v[u]=a2
if(a3<0||a3>=a4)return H.e(v,a3)
v[a3]=a2
if(q>=a4)return H.e(v,q)
v[q]=v[q]+P.y(0,(25-a2)*8)
q=$.Gt()
v=a3+3
...
I.$lazy($,"simplex","ah","Ih",function(){var z,y
z=$.pB().j1(100)
y=Math.sqrt(3)
y=new V.ed(Array(512),Array(512),0.5*(y-1),(3-Math.sqrt(3))/6,0.3333333333333333,0.16666666666666666)
y.Ic(0)
y.Ic(z)
return y})
...
if($desc instanceof Array)$desc=$desc[1]
xn.prototype=$desc
function ed(Ot,Wz,FA,VC,Mw,tK){this.Ot=Ot
this.Wz=Wz
this.FA=FA
this.VC=VC
this.Mw=Mw
this.tK=tK}ed.builtin$cls="ed"
